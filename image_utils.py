from Kolors_Controlnet_and_IPA.app import infer_canny
import requests
from rembg.bg import remove
from PIL import Image
from contrlnet_canny import outpaint
...
def apparel(source,target,background):
    ...
    fo=infer_canny('',white_image,background) #outpaint(white_image,prmpt,neg_prmpt)
    #fo=white_image
    print(fo.size)
